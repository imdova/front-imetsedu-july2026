...
export interface SsBranding { logoUrl: string; darkLogoUrl: string; footerLogoUrl: string; emailLogoUrl: string; faviconUrl: string; primaryColor: string; ogImage: string }
