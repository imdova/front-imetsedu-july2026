  ...
  },
  {
    ...
    modules: [
      ...
      },
      {
        ...
        permissions: [
          p("finance.paymentTracking.view", "View", "عرض"),
          p("finance.paymentTracking.export", "Export", "تصدير"),
          p("finance.paymentTracking.remind", "Send payment reminder", "إرسال تذكير بالدفع"),
          p("finance.paymentTracking.plan", "Adjust payment plan", "تعديل خطة الدفع"),
        ],
      },
    ],
  },
