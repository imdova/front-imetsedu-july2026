    ...
    modules: [
      {
        ...
        permissions: [
          p("leads.view", "View", "عرض"),
          p("leads.create", "Create", "إنشاء"),
          p("leads.edit", "Edit", "تعديل"),
          p("leads.delete", "Delete", "حذف"),
          p("leads.export", "Export", "تصدير", "Includes PII", "يتضمن بيانات شخصية"),
          p("leads.assign", "Assign owner", "تعيين مسؤول"),
          p("leads.import", "Bulk import", "استيراد جماعي"),
          p("leads.note", "Add note / log activity", "إضافة ملاحظة / تسجيل نشاط"),
        ],
      },
      {
        ...
        permissions: [
          p("pipelines.view", "View", "عرض"),
          p("pipelines.create", "Create", "إنشاء"),
          p("pipelines.edit", "Edit", "تعديل"),
          p("pipelines.delete", "Delete", "حذف"),
          p("pipelines.export", "Export", "تصدير", "Includes PII", "يتضمن بيانات شخصية"),
          p("pipelines.archive", "Archive pipeline", "أرشفة المسار"),
        ],
      },
      {
        ...
        permissions: [
          p("groups.view", "View", "عرض"),
          p("groups.create", "Create", "إنشاء"),
          p("groups.edit", "Edit", "تعديل"),
          p("groups.delete", "Delete", "حذف"),
          p("groups.export", "Export", "تصدير", "Includes PII", "يتضمن بيانات شخصية"),
          p("groups.assignLms", "Assign LMS course", "تعيين دورة LMS"),
          p("groups.schedule", "Schedule lectures", "جدولة المحاضرات"),
          p("groups.members", "Add / remove members", "إضافة / إزالة الأعضاء"),
          p("groups.transfer", "Transfer members between groups", "نقل الأعضاء بين المجموعات"),
        ],
      },
      {
        ...
        permissions: [
          p("crmDashboard.view", "View", "عرض"),
          p("crmDashboard.export", "Export", "تصدير", "PII / financials", "بيانات شخصية / مالية"),
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        permissions: [
          p("lmsCourses.view", "View", "عرض"),
          p("lmsCourses.create", "Create", "إنشاء"),
          p("lmsCourses.edit", "Edit", "تعديل"),
          p("lmsCourses.delete", "Delete", "حذف"),
          p("lmsCourses.export", "Export", "تصدير", "Includes PII", "يتضمن بيانات شخصية"),
          p("lmsCourses.duplicate", "Duplicate", "تكرار"),
          p("lmsCourses.enroll", "Manage enrollments", "إدارة التسجيلات"),
        ],
      },
      {
        ...
        permissions: [
          p("certificates.view", "View", "عرض"),
          p("certificates.upload", "upload certificate", "رفع شهادة"),
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        permissions: [
          p("studentsDir.view", "View", "عرض"),
          p("studentsDir.delete", "Delete", "حذف"),
          p("studentsDir.export", "Export", "تصدير", "Includes PII", "يتضمن بيانات شخصية"),
          p("studentsDir.resetPw", "Reset student password", "إعادة تعيين كلمة مرور الطالب"),
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        permissions: [
          p("invoices.view", "View", "عرض"),
          p("invoices.create", "Create", "إنشاء"),
          p("invoices.edit", "Edit", "تعديل"),
          p("invoices.delete", "Delete", "حذف"),
          p("invoices.export", "Export", "تصدير", "Includes PII", "يتضمن بيانات شخصية"),
          p("invoices.send", "Send to customer", "إرسال إلى العميل"),
          p("invoices.pdf", "Download PDF", "تنزيل PDF"),
        ],
      },
      {
        ...
        permissions: [
          p("refunds.view", "View", "عرض"),
          p("refunds.change", "change refund status", "تغيير حالة الاسترداد", "Spends real money", "ينفق أموالاً حقيقية"),
        ],
      },
      {
        ...
        permissions: [
          p("paymentTracking.view", "View", "عرض"),
          p("paymentTracking.export", "Export", "تصدير"),
          p("paymentTracking.remind", "Send payment reminder", "إرسال تذكير بالدفع"),
          p("paymentTracking.plan", "Adjust payment plan", "تعديل خطة الدفع"),
        ],
      },
    ],
  },
