...
const pages: Row[] = [
  ...
  {
    id: "lp_free_lecture_cphq_arab",
    name: "Free Lecture — CPHQ (Arab)",
    path: "/lp/free-lecture-cphq-arab",
    status: "published",
    language: "ar",
    campaign: "cphq-free-lecture",
    audience: "Arab / Gulf healthcare professionals (MSA)",
    description: "Arab-international (simplified MSA) free-lecture funnel for CPHQ — same design as the Egypt page, copy tuned for Gulf & Levant.",
    thumbnailUrl: "",
    views: 0,
    clicks: 0,
