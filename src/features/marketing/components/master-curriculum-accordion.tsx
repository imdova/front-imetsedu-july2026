          ...
          return (
            <div key={m.title}>
              <button
                ...
                className="flex w-full items-center gap-4 px-4 py-4 text-start transition-colors hover:bg-slate-50 sm:px-5"
              >
                <span className="relative grid size-11 shrink-0 place-items-center rounded-xl bg-[#0b2545] text-white">
                ...
                <span className="min-w-0 flex-1 font-bold text-[#0b2545]">{m.title}</span>
                <ChevronDown
