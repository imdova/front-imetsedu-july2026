...
function cicKnowledgeCenter(ar: boolean): FaqItem[] {
  return [
    ...
    {
      q: ar ? "ما هو شكل امتحان CIC؟" : "What is the CIC Exam format?",
      group: "exam",
      a: ar
        ? "وفق CBIC (يوليو 2026)، امتحان CIC اختيار من متعدد ويتكوّن من 150 سؤالًا، يُحتسب منها 135 سؤالًا في درجتك بينما 15 سؤالًا تجريبية لا تُحتسب ويجري اختبارها لامتحانات لاحقة. ومعرفة ذلك مفيدة: فبعض الأسئلة التي تبدو غريبة قد تكون مجرد أسئلة تجريبية لا تؤثّر في نتيجتك.\n\nيُقسَّم امتحان CIC إلى قسمين مدة كل منهما 90 دقيقة. تسبقهما مقدمة وشرح مدتهما 10 دقائق، ويفصل بينهما استراحة 16 دقيقة، ويليهما استبيان 5 دقائق. والنجاح يتطلّب درجة موزونة لا تقل عن 700 على مقياس من 300 إلى 900 — وليست نسبة مئوية من الأسئلة الصحيحة — أي أن الدرجات تُعادَل بين نسخ الامتحان بدل عدّ الإجابات الصحيحة مباشرةً. وتتوزّع الأسئلة الـ135 المحتسَبة على مجالات محتوى شهادة CIC الثمانية، ولهذا فإن التحضير المتوازن عبر كل المجالات أجدى من التركيز المفرط على مجال واحد.\n\nتفاصيل الامتحان يحدّدها CBIC وقد تتغيّر: فقد نشر CBIC بالفعل مخطط محتوى مُحدّثًا لعام 2027. لذا تحقّق دائمًا من الشكل والرسوم وشروط الأهلية الحالية مباشرةً على cbic.org قبل الحجز — فـ IMETS جهة تدريب مستقلة ولا تضع امتحان CIC ولا تديره."
        : "Per CBIC (July 2026), the CIC Exam is multiple choice and consists of 150 questions, of which 135 count toward your score and 15 are unscored pretest items being trialled for future exams. Knowing this matters: a handful of questions that strike you as unusual may simply be pretest items that do not affect your result.\n\nThe CIC Exam runs as two 90-minute sections. A 10-minute introduction and tutorial comes first, the two sections are separated by a 16-minute break, and a 5-minute survey follows at the end. Passing requires a scaled score of at least 700 on a 300–900 scale — not a percentage of questions answered correctly — so scores are equated across exam forms rather than counted raw. The 135 scored questions are distributed across the eight CIC content domains, which is why balanced preparation across every domain beats over-studying a single one.\n\nExam details are set by CBIC and do change: CBIC has already published a revised content outline for 2027. Always confirm the current format, fees, and eligibility directly at cbic.org before you book — IMETS is an independent training provider and neither sets nor administers the CIC Exam.",
    },
    {
